"""Tournament submission for groupXX (selfplay).
...
(groupXX_selfplay.zip) is bundled in the same directory as this script.
"""
...
def load_model(path=None):
    ...
    if path is None:
        ...
        path = os.path.join(here, "groupXX_selfplay.zip")
